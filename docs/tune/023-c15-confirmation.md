...
## Perf leg (measured, post-eval)
- `python3 bench/decodebench.py --decode 400 --contexts 1000,200000 --temps 0.0 --model qwen3.8-flash-next-fp8` on orcus, run 19:2xZ after the eval completed.
- 1k: prose 22.4 / code 22.4 / entropy 22.6 / copy 23.9 tok/s (TTFT 0.65-0.88s). 200k: prose 22.5 (TTFT 83.76s — first-request cold prefill artifact) / code 21.9 / entropy 22.5 / copy 23.2 tok/s (TTFT 0.68-2.23s).
- Flat ~22-24 tok/s, context-insensitive — matches the LKG band measured in TASK-73.08 (22.7/22.6/22.5/24.0 @1k, §3 of REPORT.md). No regression.
